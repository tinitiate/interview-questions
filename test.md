...
> the class has public and private fields and methods, The Public Fields and 
> methods are the ones that are exposed to other classes, And the private ones 
> are hidden, of internal class usage only.
